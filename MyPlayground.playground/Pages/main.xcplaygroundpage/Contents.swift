...
func isForceWith(a:String) -> Bool{
    if a == "Luke" || a == "Leia" || a == "Anakin" || a == "Obi" || a == "Wan" || a == "Yoda" || a == "Vader" {
        return(true)
    } else
    {
        return(false)
...
func bankAccounts(a:Double, b:Double) {
    if !(b-Double(10)<0) {
       print(a+Double(10),
        b-Double(10))
    } else {
        print("You serious, Luna?")
    }
}

bankAccounts(20.98,b:0)
bankAccounts(20.98, b:30)
